...
List<Skill> buildMockSkills() {
  return [
    Skill(
      id: 'basic_bounce',
      title: 'Basic Bounce',
      description: 'The foundation of every jump rope skill. Master the two-foot bounce before moving on.',
      youtubeId: 'dqOUclS1pDQ', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      ...
      youtubeId: 'M0C8S6RF_Fs', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      ...
      youtubeId: 'Gg3cVBmpu8U', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      ...
      description: 'Alternate feet with each rope pass — like running in place with the rope.',
      youtubeId: 'c6Mb0WcLc64', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      ...
      youtubeId: 'RrEjSgmZqz4', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      id: 'cross_overs',
      title: 'Cross Overs',
      description: 'Cross arms in front of the body as the rope passes under. Coordination at its finest.',
      youtubeId: 'nAHBUhx4H_E', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      id: 'side_swing',
      title: 'Side Swing',
      description: 'Swing the rope to the side without jumping — essential for transitions and tricks.',
      youtubeId: 'jHZDmH7EcNQ', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      id: 'triple_unders',
      title: 'Triple Unders',
      description: 'Three rope passes per jump. Explosive power and lightning-fast wrists required.',
      youtubeId: 'VaHzidAWDRQ', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      id: 'cross_double',
      title: 'Cross Double',
      description: 'Cross arms while performing a double under. Pure coordination and timing.',
      youtubeId: 'BaHlEqABqMU', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      ...
      youtubeId: 'KCLsOvNe3xo', // TODO: replace with real @samsjump YouTube ID
      tips: [
    ...
    Skill(
      id: 'freestyle',
      title: 'Freestyle',
      description: 'Chain skills into flowing combinations. This is where you create your own style.',
      youtubeId: 'fq9CHzxiAKg', // TODO: replace with real @samsjump YouTube ID
      tips: [
